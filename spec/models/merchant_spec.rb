    ...
    it "#favorite_customers" do
      ...
      expect(actual).to eq(
        [
          ...
          @customer_4.first_name,
          @customer_6.first_name
        ]
      )
    end
